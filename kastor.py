...
"""
Main module of Kastor error assessment and correction. Gathers parameters
...
from kastor_class import *
from itertools import groupby
from typing import Optional, Union


def _parse_arguments():
    """ Determine Kastor parameters
...
def adjust_initial_error(reads_mpile, detected_err: dict, adjust_sub=True):
    ...
    # TODO: To change. Implementation method can corrupt file in rare cases. Using a tmp file as backup.
    ...
    for contig, err_list in errors.items():
        try:
            ...
            sys.exit(("ERROR: Contig names do not match. Check names in "
                      "both mpileup and fasta file. Kastor only takes the "
        ...
        for correction in err_list:
            ...
            if err_type == "sub":
                if len(correction[6]) > 1:
                    # TODO: implement more sophisticated eval for substitutions
...
# skipping the module
def main(params):
    """Runs kastor modules: Error detection, Error
    ...
    # get diagnostic first before correction
...
if __name__ == "__main__":
    ...
    if args.version:
        sys.exit("Kastor version {}".format(ver))
